...
export default function(){
    return(
        <div id='contact-information' className='block'>
            ...
            <Divider/>
            <div className="links">
                <Button title={'Resume'} onClick={()=>{window.open('https://drive.google.com/file/d/1Pwe4TmAGYphZjMjo-7r8sRvnPFf8rrOW/view?usp=sharing')}} style={{margin:'auto'}} icon circular size='large' color='orange'>
                    <Icon name='download'/>
                </Button>
